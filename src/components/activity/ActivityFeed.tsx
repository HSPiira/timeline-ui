...
import type { ActivityFilter } from '@/lib/types/activity'
 ...
 */
export function ActivityFeed({ filter, limit = 20 }: ActivityFeedProps) {
  return (
    <ActivityProvider>
      <ActivityFeedContent filter={filter} limit={limit} />
    </ActivityProvider>
  )
}
 ...
 */
function ActivityFeedContent({ filter, limit }: ActivityFeedProps) {
