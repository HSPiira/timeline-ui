...
export function EventCard({
  ...
  return (
    <div className="bg-gradient-to-r from-card to-card/50 backdrop-blur-sm rounded-xs p-3 sm:p-4 border border-transparent hover:border-blue-200/60 dark:hover:border-blue-800/40 transition-colors shadow-sm hover:shadow-md">
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-start gap-2 sm:gap-2.5 flex-1 min-w-0">
          {/* Event Icon */}
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xs bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 mb-2 flex-wrap">
              ...
              {hasDocuments && (
                <button
                  ...
                  className="inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 bg-blue-100 dark:bg-blue-950/30 text-blue-700 dark:text-blue-300 rounded-xs hover:bg-blue-200 dark:hover:bg-blue-900/40 transition-colors text-xs flex-shrink-0"
              ...
              {onViewDetails && (
                <button
                  ...
                  className="px-1.5 sm:px-2 py-0.5 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-950/30 rounded-xs transition-colors flex-shrink-0"
                  title="View details"
                >
