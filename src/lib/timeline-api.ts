...
export interface paths {
    ...
    "/event-schemas/": {
        ...
        /**
         * Create Event Schema
         * @description Create a new event schema for the tenant
         */
    ...
    "/event-schemas/{schema_id}": {
        ...
        /**
         * Delete Event Schema
         * @description Delete an event schema (soft delete by deactivating)
         */
        ...
        /**
         * Update Event Schema
         * @description Update an event schema (activate/deactivate)
         */
